...
\centerline{{\small Universidad de Buenos Aires - Facultad de Ciencias Exactas y Naturales - Depto. de Matemática}}
 ...
 \medskip
 \centerline{\bf {Práctica 5: Ecuaciones Diferenciales de Primer Orden.}}
 \medskip
...
\begin{enumerate}
\item[(a)] Caracterizar (encontrar la ecuaci\'on) de las poblaciones con
tasa de cre\-ci\-miento cons\-tante.

\item[(b)] Dibujar el gr\'afico de $y(t)$ para poblaciones con tasa de
crecimiento cons\-tante, positiva y negativa.

\item[(c)] ?`Cu\'ales son las poblaciones con tasa de crecimiento nula?

\item[(d)] Una población tiene tasa de crecimiento constante. El 1 de
...
\item[(e)] Caracterizar las poblaciones cuya tasa de crecimiento es una
