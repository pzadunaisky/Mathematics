...
and $\D(\Mod A^\op)$, where $A^\op$ denotes the opposite algebra of $A$. 
A graded dualizing complex in principle only guarantees 
...
he omits) turns on the fact that a graded injective module has injective 
