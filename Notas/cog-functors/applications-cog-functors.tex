...
is refered to \cite{NV-book-3}*{Chapter 2} for proofs and details. Given an 
object $M$ of $\Mod^G A$, we will denote by $\projdim_A^G M$ and $\injdim_A^G 
...
\end{align*}
Now by the graded version of the Bass-Papp theorem (see \cite for a proof in 
