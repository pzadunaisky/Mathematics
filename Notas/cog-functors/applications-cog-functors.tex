...
noetherian if and only if it is $\ZZ^r$-noetherian. We also assume that $A_0 = 
\k$. We denote by $\D^{\ZZ^r}(A), \D^{\ZZ^r}(A^\op)$ and $\D^{\ZZ^r}(A^e)$ the 
derived 
...
resolution of a complex $R^\bullet$ is an isomorphism $R^\bullet \to I^\bullet$
in $\D^{\ZZ^r}(A)$ where all the modules of the complex $I^\bullet$ are 
injective $\ZZ^r$-graded modules, and that the injective dimension of 
...
Assume $A$ is left noetherian. If $R^\bullet$ is an object of $\D^{\ZZ^r}(A)$ then
\[
